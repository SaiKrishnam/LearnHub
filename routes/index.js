...
c6.save(function (err, c6) {
    if (err) return console.error(err);
    console.log("success");
});


c7.save(function (err, c7) {
    if (err) return console.error(err);
    console.log("success");
});

c8.save(function (err, c8) {
    if (err) return console.error(err);
    console.log("success");
});

c9.save(function (err, c9) {
    if (err) return console.error(err);
    console.log("success");
});
c10.save(function (err, c10) {
    if (err) return console.error(err);
    console.log("success");
});
c11.save(function (err, c11) {
    if (err) return console.error(err);
    console.log("success");
});


c12.save(function (err, c12) {
    if (err) return console.error(err);
    console.log("success");
});

c13.save(function (err, c13) {
    if (err) return console.error(err);
    console.log("success");
});

c14.save(function (err, c14) {
    if (err) return console.error(err);
    console.log("success");
});
c15.save(function (err, c15) {
    if (err) return console.error(err);
    console.log("success");
});
c16.save(function (err, c16) {
    if (err) return console.error(err);
    console.log("success");
});


c17.save(function (err, c17) {
    if (err) return console.error(err);
    console.log("success");
});

c18.save(function (err, c18) {
    if (err) return console.error(err);
    console.log("success");
});

c19.save(function (err, c19) {
    if (err) return console.error(err);
    console.log("success");
});
c20.save(function (err, c20) {
    if (err) return console.error(err);
    console.log("success");
});
